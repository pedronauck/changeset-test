...
- ✨ Feat: accept a theme object for custom theme on `<ThemeProvider>`, by [@pedronauck](https://github.com/pedronauck) (See [#105](https://github.com/pedronauck/changeset-test/pull/105))
- ✨ Feat: expose a `cssObj` function that help on css objects creation, by [@pedronauck](https://github.com/pedronauck) (See [#105](https://github.com/pedronauck/changeset-test/pull/105))

### Patch Changes

- 💅🏻 Style: general adjustments according to Figma design specs, by [@pedronauck](https://github.com/pedronauck) (See [#105](https://github.com/pedronauck/changeset-test/pull/105))
